...
const Chat: React.FC = () => {
  ...
  // Socket reconnect/disconnect handling
  useEffect(() => {
    if (!socket) return;
    ...
    <div className="flex h-full">
      ...
      <div className="w-80 bg-white/5 border-r border-white/10 backdrop-blur-sm">
        <div className="p-6 border-b border-white/10 flex items-center justify-between">
          ...
          <div className="flex items-center">
            {!isReconnecting && socket?.connected ? (
              ...
              >
                <div className="flex items-center">
                  <div className="w-12 h-12 bg-gradient-to-r from-cyan-500 to-blue-500 rounded-full flex items-center justify-center mr-3">
                    {chat.chatType === 'group' ? <Users className="h-6 w-6 text-white" /> : <MessageCircle className="h-6 w-6 text-white" />}
                  </div>
      ...
      <div className="flex-1 flex flex-col">
        {activeChat ? (
          <>
            {/* Chat Header */}
            <div className="bg-white/5 border-b border-white/10 p-6 backdrop-blur-sm flex items-center">
              ...
              <div>
                ...
                {activeChat.chatType === 'group' && (
                  <p className="text-sm text-white/60">{activeChat.participants.length} members</p>
                )}
              </div>
            </div>
